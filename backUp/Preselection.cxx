/* func pres ( &newf, & Sample, & Q2Bin )

take old tree of Sample
determine type of cut (use a function): determined by isMC, Q2Bin
loop over old tree, write in newtree of newf
...
// Date: 2016-05-06
//
// Implementation file for Functions : preselection of samples
//
//==============================================================================

#include "Preselection.h"

void MakePreselection(&TFile newFile, &Sample mySample, &Q2Bin myQ2Bin)
{
  // Init files and trees

  // MC AND DATA HAVE TO GET INIT DIFFERENTLY BECAUSE OF BKGCAT
  TFile* oldFile = mySample->GetFile();
  TTree *oldTree = (TTree*)oldFile->Get( mySample->GetTreeName() );
