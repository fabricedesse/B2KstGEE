...
BINS = Main
# ADD = create_tree.cxx
DIC = VELO.cxx Station.cxx make_plots.C VELO_geometry.C Beam.cxx plot_cut.cxx Sample.cxx Q2Bin.cxx
...
$(BINS): % : %.cxx VELO.h Station.h make_plots.h VELO_geometry.h plot_cut.h Beam.h Sample.h Q2Bin.h
	@echo -n "Building $@ ... "
